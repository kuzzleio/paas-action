  ...
  async deploy() {
    ...
    try {
      ...
      const response = await fetch(
        `${this.inputs.paas_api}/_/projects/${this.inputs.project.replace("paas-project-", "")}/environments/${this.inputs.environment}/applications/${this.inputs.application}/_deploy`,
        options);
      const result = await response.json();
